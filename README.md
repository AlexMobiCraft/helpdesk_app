...
Пользователи могут создавать заявки на ремонт/сервис, прикладывать файлы; техники — брать заявки в работу, менять статус, оставлять заметки; администратор — управлять справочниками (типы устройств, статусы заявок, приоритеты заявок, роли), пользователями и выгружать отчёты.
